...
const createMemorySchema = z.object({
  ...
  personalRating: z.number().min(1).max(10).optional().nullable(),
  auditoriumRating: z.number().min(1).max(10).optional().nullable(),
  soundRating: z.number().min(1).max(10).optional().nullable(),
  screenRating: z.number().min(1).max(10).optional().nullable(),
  experience: z.number().min(1).max(10).optional().nullable(),
